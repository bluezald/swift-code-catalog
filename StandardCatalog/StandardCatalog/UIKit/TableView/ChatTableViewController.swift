...
class ChatTableViewController: UITableViewController {
  ...
  override func viewDidLoad() {
    ...
    showMessage(type: .outgoing, text: "The quick brown fox jumps over the lazy dog")
  }
...
extension ChatTableViewController {
  ...
  func showMessage(type: BubbleMessageType, text: String) {
    let label =  UILabel()
...
class BubbleView: UIView {
  ...
  var messageType: BubbleMessageType = .outgoing
